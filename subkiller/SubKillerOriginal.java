...
import javax.swing.*;
// *** DONT import java.util.Timer!! it has to be javax.swing.Timer!!
...
public class SubKillerOriginal extends JPanel {
    ...
    public static void main(String[] args) {
        ...
        SubKillerOriginal content = new SubKillerOriginal();
    ...
    public SubKillerOriginal() {
        ...
        //***these are anonymous inner classes -- defining a new class
        // while at the same time creating a new object of that type
        // MouseAdapter class implements MouseListener,MouseMotionListener, so you don't have
        // to have a bunch of blank methods.
        ...
        //***this is also an anonymous inner class.
        // Like MouseAdapter, KeyAdapter already implements KeyListener, 
        // so you don't have to provide empty methods for keyTyped() and keyReleased()
