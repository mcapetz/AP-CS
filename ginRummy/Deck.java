...
public class Deck {
    ...
    public void shuffle() { 	
    	...
    	for(int i = 0; i < deck.length; i++) {
    		...
    		Card temp = deck[i]; //slightly biased, change to i to n-1 to make each one have equally likelihood of being chosen
    		deck[i] = deck[r];
    		deck[r] = temp;
    	}
    ...
    public Card dealCard() {
    	cardsUsed++;
    	return deck[cardsUsed - 1]; //need to increment before returning
